...
df.to_csv('C:/Users/Lila/Desktop/PROJECT_2.2_EXT/triangles_time/tri_time.csv', index=False)
...
res.to_csv('experiments/results/triangles_2/operators/GDI.csv', columns = ['avg'])
...
res.to_csv('experiments/results/triangles_2/operators/PDI.csv', columns = ['avg'])
...
res.to_csv('experiments/results/triangles_2/operators/GAU.csv', columns = ['avg'])
...
res.to_csv('experiments/results/triangles_2/operators/GDU.csv', columns = ['avg'])
